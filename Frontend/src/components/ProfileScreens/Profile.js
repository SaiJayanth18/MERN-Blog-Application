...
// Function to format and return the creation date of the account
    ...
    useEffect(() => {
        ...
        const getUserProfile = async () => {
            ...
            try {
                ...
                // If an error occurs, navigate back to the home page
                navigate('/')
            }
        }
 // Call the function to get user profile on component mount
        getUserProfile()
    }, [setLoading])
