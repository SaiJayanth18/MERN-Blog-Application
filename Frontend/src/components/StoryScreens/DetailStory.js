...
// useEffect to fetch the story details when the component mounts
  useEffect(() => {
...
// Function to handle the story deletion
...
// Function to format the creation date of the story
...
// Function to add the story to the user's read list
