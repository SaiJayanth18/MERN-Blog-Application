...
// Functional component 'Story' that takes a 'story' object as a prop
const Story = ({ story }) => {
// Function to format and return the creation date of the story
...
// Function to truncate the content of the story for display
    const truncateContent = (content) => {
        const trimmedString = content.substr(0, 73);
        return trimmedString
    }
    // Function to truncate the title of the story for display
